...
#define JY_DRAW_TEXT_AT_POINT(text, point, font, color) [text drawAtPoint : point withAttributes : @{ NSFontAttributeName:font, NSForegroundColorAttributeName: color }];
...
#define JY_DRAW_TEXT_AT_POINT(text, point, font, color) [text drawAtPoint : point withFont : font];
